...
* `check_input_value()` -- Check that the value of an input supplied to a parent function is appropriate;
* `check_input_class()` -- Check that the class of an inputted object supplied to a parent function is appropriate;
